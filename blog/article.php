...
<?php
    ...
    <div class="col-10">
      <h2><?php echo $art['title'];?></h2>
        <!--   <img src="https://i.picsum.photos/id/640/180/180.jpg?hmac=ZNk3UYYKQwk43jr8LahXP1pAa4-RNfqFL_gsWdYKJrM" class="float-left" style="float: left;margin-right: 15px;"> -->
        <img src="/static/images/<?php echo $art['images'];?>" class="float-left" style="float: left;margin-right: 15px; max-width: 180">
